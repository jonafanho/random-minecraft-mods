...
public interface Blocks {
	...
	Block CLASSIC_EXPLOSIVE = new BlockExplosive(FabricBlockSettings.of(Material.METAL), 4, false);
	Block BIG_EXPLOSIVE = new BlockExplosive(FabricBlockSettings.of(Material.METAL), 16, false);
	Block NUKE = new BlockExplosive(FabricBlockSettings.of(Material.METAL), 40, true);
